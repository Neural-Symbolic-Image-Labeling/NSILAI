...
def get_total_list1(input_list):
    ...
    for image_num in range(len(input_list)):
        ...
        for objects_num in range(len(input_list[image_num]['overlap'])):
            object1_name = \
            input_list[image_num]['object'][str(input_list[image_num]['overlap'][str(objects_num)]["idA"])]['name']
            object2_name = \
            input_list[image_num]['object'][str(input_list[image_num]['overlap'][str(objects_num)]["idB"])]['name']
            position1 = total_object.index(object1_name)
            position2 = total_object.index(object2_name)
            if position1 < position2:
                overlap = "overlap(" + str(position1) + "," + str(position2) + ")"
...
>>>>>>> a51f06438e78a2a4cbcc4591308bf3c542b379ce
                            ...
                            if a[1] in parameter_list and threshold(target, possible_clause[clause_number],
                                                                    total_list) != False:
